...
const Kubernetes_Networking: React.FC = () => {
  ...
  if (parent === "Kubernetes" && child === "Networking" && grandChild === "Quiz")
      ...
      >
        <div>
          <div>
            ...
            {/* 1. Comportement par défaut des pods sans Storage Context */}
            <section>
              <h2>1. Comportement par défaut des pods sans Storage Context</h2>
              <p>
                Par défaut, si aucun <strong>Storage Context</strong>{" "}
              ...
              <ul>
                <li>
                  Configurer le <code>runAsNonRoot: true</code> dans le Storage
                  Context.
                </li>
                <li>
    ...
    - Egress`}
            ...
            <section>
              ...
              <p>
                ...
                Storage Context rend le système de fichiers du conteneur{" "}
      ...
      securityContext:
        runAsNonRoot: true`}
            ...
            <section>
              ...
              <p>
                Le champ <code>PodStoragePolicy</code> permet de limiter les
              ...
              <pre>
                <code>
                  apiVersion: extensions/v1beta1 kind: PodStoragePolicy
  ...
  ports:
    - protocol: TCP
      ...
      targetPort: 8080`}
            ...
            <section>
              <h2>
                26. Contrôle d&apos;admission PodStoragePolicy pour empêcher
                l&apos;exécution en tant qu&apos;utilisateur root
              </h2>
              <p>
                Le <strong>PodStoragePolicy</strong> permet de définir des
...
spec:
  ...
  admissionReview:
    name: validate-image`}
            ...
            <section>
              <h2>
                30. PodStoragePolicy pour restreindre les capacités des
                conteneurs
              </h2>
              <p>
                Le <strong>PodStoragePolicy</strong> permet d&apos;imposer des
  ...
  allowedCapabilities: ["NET_BIND_SERVICE", "IPC_LOCK"]`}
            ...
            <section>
              ...
              <p>
                ...
                <strong>Storage Context</strong> du pod. Cela empêche
            ...
            <section>
              ...
              <p>
                ...
                <strong>Storage Context</strong> du pod. Cela garantit que le
              ...
              <p>
                ...
                <strong>Storage Context</strong> permet d&apos;exécuter le
    ...
    providers:
      - aescbc:
          keys:
            ...
            <section>
              <h2>
                54. Admission des valeurs par défaut via PodStoragePolicy
              </h2>
              <p>
                Le contrôleur d&apos;admission{" "}
                <strong>PodStoragePolicy</strong> permet de définir et
...
spec:
  runAsUser:
    rule: MustRunAsNonRoot`}
            ...
            <section>
              <h2>55. Utilisation de runAsGroup dans le Storage Context</h2>
              <p>
                L&apos;option <code>runAsGroup</code> dans le{" "}
                <strong>Storage Context</strong> garantit que le conteneur
            ...
            <section>
              ...
              <p>
                ...
                non-root dans le Storage Context.
              </p>
              <h3>Bonne pratique :</h3>
              <ul>
                <li>
    ...
    verbs: ["get", "watch", "list"]`}
            ...
            <section>
              ...
              <p>
                ...
                <strong>Storage Context</strong> du conteneur empêche son
                exécution en mode privilégié.
              </p>
              <h3>Bonne pratique :</h3>
              <ul>
                <li>
                  Appliquer une <code>PodStoragePolicy</code> ou son équivalent
            ...
            <section>
              <h2>
                ...
                Storage Admission (PSA) dans Kubernetes ?
              </h2>
              <p>
                Le contrôleur <code>Pod Storage Admission</code> valide et
      ...
      securityContext:
        hostPID: false`}
            ...
            <section>
              ...
              <ul>
                ...
                <li>
                  ...
                  <strong>PodStoragePolicies</strong>.
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p>
                Le contrôleur d&apos;admission{" "}
                <strong>PodStoragePolicy</strong> peut être configuré pour
              ...
              <ul>
                <li>
                  Appliquer des PodStoragePolicies strictes pour protéger le
                  cluster.
                </li>
              </ul>
            </section>
            ...
            <section>
              <h2>95. Effet de l&apos;activation de `PodStorageAdmission`</h2>
              <p>
                La fonctionnalité <code>PodStorageAdmission</code> permet de
            ...
            <section>
              ...
              <p>
                L&apos;admission controller <code>PodStoragePolicy</code>{" "}
