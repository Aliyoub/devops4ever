...
import { questions } from "./questionsTroubleshooting";

const Kubernetes_Troubleshooting: React.FC = () => {
  ...
  if (parent === "Kubernetes" && child === "Troubleshooting" && grandChild === "Quiz")
...
export default Kubernetes_Troubleshooting;
