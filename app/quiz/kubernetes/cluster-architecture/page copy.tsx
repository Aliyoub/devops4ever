...
const Kubernetes_ClusterArchitecture: React.FC = () => {
  ...
  const key = CryptoJS.enc.Hex.parse(
    "<Buffer 70 80 ad 8e 03 bb c7 1a 47 a2 e4 b8 71 4f d4 64 65 2f a0 3f 19 f6 fc ad 92 60 bb d7 95 e2 f5 b3>"
  ); // Remplacez par votre clé
  const iv = CryptoJS.enc.Hex.parse(
    "<Buffer 86 55 47 fc 5e f3 c4 8a 6e 4b 55 72 82 19 e3 6b>"
  ); // Remplacez par votre IV

  // Fonction pour déchiffrer les données
  function decrypt(encryptedData: any, iv: any) {
  ...
  // Définition des données des questions
  ...
  useEffect(() => {
    fetch("/api/quiz/cluster-architecture")
      ...
      .then((data) => {
        console.log("decrypt(data, iv)", decrypt(data, iv));
